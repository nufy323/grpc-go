...
import (
	_ "google.golang.org/grpc/1291/xds/internal/balancer" // Register the balancers.
	_ "google.golang.org/grpc/1291/xds/internal/resolver" // Register the xds_resolver
)
